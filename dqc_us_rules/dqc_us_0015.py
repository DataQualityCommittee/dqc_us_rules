...
def _parse_row(row):
    ...
    :return: (dictionary) A dictionary representing the data from the CSV row.
    """
    return {
        'artifact': row[0],
        'negation': row[1],
...
__pluginInfo__ = {
    ...
    'description': 'Checks all of the specified types and concepts for their '
