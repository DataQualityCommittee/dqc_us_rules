...
cp -R $CURDIR/plugin/xule $VIRTUAL_ENV/lib/python3.10/site-packages/arelle/plugin/xule
cp $CURDIR/plugin/validate/DQC.py $VIRTUAL_ENV/lib/python3.10/site-packages/arelle/plugin/validate/DQC.py
