...
class TestDQC0014(unittest.TestCase):
    def setUp(self):
        ...
        # Fact is numeric, has NEGATIVE value, concept in blacklist, and HAS dimensions = No Fire
        self.fact_one = mock.Mock(
            concept=mock_concept1, qname=m_qn_fire1, value=-7,
            namespaceURI='http://xbrl.sec.gov/us-gaap/2014-01-31',
            context=mock_context1
        )
        # Fact is numeric, has NEGATIVE value, concept in blacklist, but HAS NO dimensions = Fire
        self.fact_two = mock.Mock(
            concept=mock_concept2, qname=m_qn_fire2, value=-77,
            namespaceURI='http://xbrl.sec.gov/us-gaap/2014-01-31',
            context=mock_context4
        )
        # Fact is numeric, has POSITIVE value, concept in blacklist, and HAS NO dimensions = No Fire
        self.fact_three = mock.Mock(
            concept=mock_concept3, qname=m_qn_fire3, value=7,
            namespaceURI='http://xbrl.sec.gov/us-gaap/2014-01-31',
            context=mock_context4
        )
        # Fact is numeric, has POSITIVE value, concept NOT IN blacklist, and HAS NO dimensions = No Fire
        self.fact_four = mock.Mock(
            concept=mock_concept4, qname=m_qn_no_fire1, value=77,
            namespaceURI='http://xbrl.sec.gov/us-gaap/2014-01-31',
            context=mock_context4
        )
        # Fact is numeric, has POSITIVE value, concept in blacklist, and HAS dimensions = No Fire
        ...
        self.fact_seven = mock.Mock(
            concept=mock_concept6, qname=m_qn_no_fire2, value='true',
            namespaceURI='http://xbrl.sec.gov/us-gaap/2014-01-31',
            context=mock_concept4
        )
        # Fact is numeric, has NEGATIVE value, concept in blacklist, and HAS NO dimensions = Fire
        self.fact_eight = mock.Mock(
            concept=mock_concept3, qname=m_qn_fire3, value=-777,
            namespaceURI='http://xbrl.sec.gov/us-gaap/2014-01-31',
            context=mock_context4
        )
        # Fact is numeric, has NEGATIVE value, concept in blacklist, and HAS NO dimensions = No Fire
        self.fact_nine = mock.Mock(
            concept=mock_concept3, qname=m_qn_fire3, value=-77.7,
            namespaceURI='http://xbrl.sec.gov/us-gaap/2014-01-31',
            context=mock_context3
        )
