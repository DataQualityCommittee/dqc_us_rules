...
class TestDQC0015(unittest.TestCase):
    def test_contains(self):
        ...
        check_list = 'Credit'
        self.assertTrue(util.neg_num.contains(element_one, check_list))
        self.assertFalse(util.neg_num.contains(element_two, check_list))
    ...
    def test_contains_insensitive(self):
        ...
        check_list = 'CreDIt'
        self.assertTrue(
            util.neg_num.contains_insensitive(element_one, check_list)
        )
        self.assertTrue(
            util.neg_num.contains_insensitive(element_two, check_list)
        )
    ...
    def test_equals(self):
        ...
        self.assertTrue(util.neg_num.equals(element_one, check_list))
        self.assertFalse(util.neg_num.equals(element_two, check_list))
        self.assertFalse(util.neg_num.equals(element_three, check_list))
        self.assertTrue(util.neg_num.equals(1.0, '1.0'))
        self.assertTrue(util.neg_num.equals(1, '1.0'))
        self.assertTrue(util.neg_num.equals(1.00, '1'))
        self.assertTrue(util.neg_num.equals(1.00, '1.00'))
        self.assertTrue(util.neg_num.equals('NaN', 'NaN'))
        self.assertFalse(util.neg_num.equals("NaN", '1'))
        self.assertFalse(util.neg_num.equals(0, 'zero'))
    ...
    def test_parse_row(self):
        ...
        rule = util.neg_num._parse_row(test_row)
    ...
    def test_actual_rule_config(self):
        ...
        blacklist_exclusion_rules = util.neg_num.get_rules_from_csv(dqc_us_0015._DEFAULT_EXCLUSIONS_FILE)
...
class TestBuildDict(unittest.TestCase):
    def setUp(self):
        ...
        with mock.patch(open_name, create=True) as m:
            ...
            self.blacklist_exclusion_rules = util.neg_num.get_rules_from_csv(dqc_us_0015._DEFAULT_EXCLUSIONS_FILE)
        self.rule_one = util.neg_num._parse_row(
            self.csv_lines[0].split(',')[1:]
        )
        self.rule_two = util.neg_num._parse_row(
            self.csv_lines[1].split(',')[1:]
        )
        self.rule_three = util.neg_num._parse_row(
