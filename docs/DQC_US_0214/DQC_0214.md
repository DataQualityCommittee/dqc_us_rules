...
For filings that include Accumulated Other Comprehensive Income (AOCI) items, the rule message references the FASB implementation guide for AOCI to assist filers: https://xbrl.fasb.org/impguidance/
