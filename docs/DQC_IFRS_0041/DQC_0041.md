...
This rule evaluates whether the dimension default for an axis in the _extension taxonomy_ is the same as the default for that axis in the _extension taxonomy_.  Companies should not change the default member defined in the _base taxonomy_ for a given axis in their _extension taxonomy_. 
