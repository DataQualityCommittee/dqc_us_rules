...
**Note (2026 taxonomy):** Rule element DQC.US.0121.9581 (the second component covering ASU 2016-02, ASU 2017-12, and ASU 2018-07 transition elements) has been removed from the 2026 taxonomy year rule file. That check is no longer active for filings using the 2026 US GAAP taxonomy.
