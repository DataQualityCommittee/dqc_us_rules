...
| ----- | ----- |
| DQC_0033 | All DEI elements in the instance are tested except for EntityCommonStockSharesOutstanding, EntityPublicFloat, DocumentPeriodEndDate, EntityNumberOfEmployees, AuditorLocation, AuditorName, AuditorFirmId, and Entity Listing, Depository Receipt Ratio | 
