...
|--------|--------|
|DQC.US.0074.7649|RevenueRemainingPerformanceObligationExpectedTimingOfSatisfactionStartDateAxis, OpenFuturesContractIdentifierAxis, OpenForwardForeignCurrencyContractIdentifierAxis, OpenOptionContractIdentifierAxis, OpenSwapContractIdentifierAxis, SecuritySoldShortIdentifierAxis, InvestmentIdentifierAxis, ReinsuranceContractAxis,DisaggregationOfIncomeStatementExpenseCaptionIdentifierAxis, NameChangeEventDateAxis|
