...
## The version 11 update for public exposure proposes the addition of 62 concepts from the 2019 IFRS taxonomy that cannot be negative - see the filtered listing linked above. 
