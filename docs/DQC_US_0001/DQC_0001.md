...
Latest Committee-approved update: October 10, 2018 (see Appendix A for post-implementation edits) 
> *Appendix A*: [Axis changes](#axischanges) | [Version 3 update](#version3) | [Version 6 update](#v6) | [Version 7 update](#v7)  
...
DQC.US.0001.51 limits the members allowed on the Fair Value, Hierarchy [Axis] to the members defined in the taxonomy and two extension elements listed below: 
...
*   Add Note 3 - Allowable US-GAAP members on the ProductOrServiceAxis
	  *  RealEstateMember
	  *  HotelMember
*   Add FairValueInputsLevel12And3Member, FairValueInputsLevel1AndLevel3Member and FairValueMeasuredAtNetAssetValuePerShareMember DQC.US.0001.51
