...
Latest Committee-approved update: March 28, 2017 (see Appendix A for post-implementation edits) 
> *Appendix A*: [Axis changes](#axischanges) | [Version 3 update](#version3)  
...
*   Add StatementEquityComponentsAxis DQC_0001.75 (January 1, 2017) 
...
*   Add StatementScenarioAxis DQC_0001.76 (January 1, 2017)
*   Add RangeAxis DQC_0001.61 (January 1, 2017)

**<a name="version3"></a>Updated Axis Member Exclusions - March 2017**
DQC_0001.15 limits the members allowed on the Fair Value, Hierarchy [Axis] to the members defined in the taxonomy and two extension elements listed below: 
...
Updated to support 2017 US GAAP Financial Reporting Taxonomy (April, 2017)
