...
See file [DQC_0009_ListOfElements](DQC_0009_ListOfElements.xlsx) for the elements tested by this rule. Elements are listed in order by the most commonly occurring errors.
