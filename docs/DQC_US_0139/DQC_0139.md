...
#### Component 4
This component identifies those cases where the percentage of the Tier 1 capital to be adequately capitalized is greater than the percentage of Tier One capital to be well capitalized.

#### Component 5
This component identifies those cases where the value of the Tier 1 capital to be adequately capitalized is greater than the value of Tier One capital to be well capitalized.
...
#### Component 4
The percentage of the Tier 1 capital to be adequately capitalized of 0.105 is greater than the percentage of Tier One capital to be well capitalized with a value of  0.06. 
...
Period: 2018-06-30  
Dimensions: dei:LegalEntityAxis=jpm:BankHoldingCompaniesMember, us-gaap:RiskWeightedAssetsCalculationMethodologyAxis=jpm:BaselIIIMember  
Unit: pure
...
#### Component 5
The value of the Tier 1 capital to be adequately capitalized of 170,958,000 is greater than the value of Tier One capital to be well capitalized with a value of  160,902,000. 

Confirm that the Tier One capital values have been tagged correctly.
