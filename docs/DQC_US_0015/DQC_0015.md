...
Latest Committee-approved update: June, 2017 (see Appendix B for post-implementation edits) 
...
*   DerivativeAssetFairValueGrossLiabilityAndObligationToReturnCashOffset (730) (Version 4 - TBD)
*   AmountOfRestrictedNetAssetsForConsolidatedAndUnconsolidatedSubsidiaries (6183) (Version 4 - TBD)
