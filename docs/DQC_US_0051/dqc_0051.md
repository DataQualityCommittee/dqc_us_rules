...
The rule checks that the preceding elements do not participate in a calculation that have an income tax element as a descendent. If any of the preceding elements have any of the following elements as a descendent then a seperate error should result:
