...
Latest Committee-approved update: On April 23, 2019, the Committee approved exposing for [public comment May 1 - June 15, 2019 additional equivalence for treasury stock for Common Stock and Preferred Stock](https://xbrl.us/dqc_0011-v9#comments). See [the DQC_0011_ListOfElements spreadsheet](DQC_011_ListOfElements.xlsx?raw=true) for details.  
