...
Latest Committee-approved update: On April 23, 2019, the Committee approved an update to include additional equivalence for treasury stock for Common Stock and Preferred Stock. See [the DQC_0011_ListOfElements spreadsheet](DQC_011_ListOfElements.xlsx?raw=true) for details.
