...
_Prior to adoption of ASU-2016-18_

1.  CashAndCashEquivalentsPeriodIncreaseDecrease
2.  CashAndCashEquivalentsPeriodIncreaseDecrease  
    ExcludingExchangeRateEffect
3.  CashPeriodIncreaseDecrease
4.  CashPeriodIncreaseDecreaseExcludingExchangeRateEffect

_Subsequent to adoption of ASU-2016-18_

1.  CashCashEquivalentsRestrictedCashAndRestrictedCashEquivalents  
    PeriodIncreaseDecreaseIncludingExchangeRateEffect
2.  CashCashEquivalentsRestrictedCashAndRestrictedCashEquivalents  
    PeriodIncreaseDecreaseExcludingExchangeRateEffect
3.  NetCashProvidedByUsedInContinuingOperations (Only if the element NetCashProvidedByUsedInDiscontinuedOperations is also included as a root element)
