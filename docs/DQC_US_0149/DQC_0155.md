...
The rule will not fire if there are no descendant elements at all.  The rule will only fire where a value has been reported for an effect of the exchange rate element.  
