...
## Rule function
This rule checks to ensure that tax reconciliation items have been selected correctly. The rule looks at 4 reconciliation items to check. They are as follows:
