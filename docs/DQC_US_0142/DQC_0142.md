...
|Rule Element ID|Elements/Axis|
|--- |--- |
|DQC.US.0142.9864|<ul><li>InvestmentIdentifierAxis</li><li>SecuritySoldShortIdentifierAxis</li><li>OpenOptionContractIdentifierAxis</li><li>OpenFuturesContractIdentifierAxis</li><li>OpenForwardForeignCurrencyContractIdentifierAxis</li><li>OpenSwapContractIdentifierAxis</li></ul>|
