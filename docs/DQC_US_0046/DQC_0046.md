...
Latest Committee-approved update: On April 23, 2019 the rule was updated to include DQC.US.0046.9279 as noted in the Rule element ID index below.
...
| DQC.US.0046.9279 | OtherComprehensiveIncomeLossNetOfTax, OtherComprehensiveIncomeLossBeforeTax, OtherComprehensiveIncomeLossNetOfTaxPortionAttributableToParent, OtherComprehensiveIncomeLossBeforeTaxPortionAttributableToParent | NetIncomeLoss | inf |
